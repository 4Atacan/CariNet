...
const styles = StyleSheet.create({
  ...
  form: { backgroundColor: '#fff', borderRadius: 12, padding: 14, gap: 8, marginTop: 8 },
  ...
  status: { fontSize: 11, fontWeight: '600', color: '#0f172a' },
  ...
  replyLabel: { fontSize: 11, fontWeight: '600', color: '#047857' },
  replyBody: { fontSize: 14, color: '#065f46' },
