...
const styles = StyleSheet.create({
  ...
  choiceText: { color: '#334155', fontWeight: '500' },
  ...
  optionActive: { borderColor: '#0f172a', backgroundColor: '#f1f5f9' },
  optionLabel: { color: '#0f172a', fontWeight: '500' },
  optionValue: { color: '#475569', fontVariant: ['tabular-nums'] },
  button: {
  ...
  secondaryButtonText: { color: '#64748b', fontSize: 14 },
  smallButton: {
    borderWidth: 1,
    borderColor: '#cbd5e1',
    borderRadius: 8,
  ...
  smallButtonText: { color: '#0f172a', fontSize: 13, fontWeight: '500' },
  reference: {
    fontSize: 20,
    fontWeight: '700',
    letterSpacing: 1,
  ...
  iban: { fontSize: 15, color: '#0f172a', fontFamily: 'monospace' },
  hint: { fontSize: 12, color: '#64748b', lineHeight: 17 },
  error: { backgroundColor: '#fef2f2', color: '#b91c1c', padding: 12, borderRadius: 8 },
  amountRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  amountSmall: { fontSize: 15, color: '#334155', fontVariant: ['tabular-nums'] },
});
